...
public class DiesCorrectesII {
   ...
   public static void main(String[] args) {
           ...
           any = ent.nextInt();
            ...
            if(dia==366 && (any%4==0 && any%100 != 0 || any%400 == 0)) System.out.println("Correcte i any bixest!");
            else if(dia==366 && !(any%4==0 && any%100 != 0 || any%400 == 0)) System.out.println("Incorrecte per any no bixest!");
